...
def main(argv):
    ...
    convert_vcf_to_phase_input(args.vcf_file, args.sample_file, args.sp1_id, args.sp2_id, args.hybrid_id, args.imputed_md_id, args.allele_transformation, args.output_dir, args.tvi_list)
...
def convert_vcf_to_phase_input(vcf_file, sample_file, sp1_id, sp2_id, hybrid_id, imputed_md_id, allele_transformation, output_dir, tvi_list):
    '''
