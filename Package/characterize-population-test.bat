...
rem This script performs a test of the program characterize-population.py
...
rem Run the program characterize-population.py

%PYTHON% %PYTHON_OPTIONS% characterize-population.py ^
    --threads=1 ^
    --db=%DATA_DIR%\test-SUBERINTRO-ALandEN-2-filtered.db ^
    --vcf=%DATA_DIR%\test-SUBERINTRO-ALandEN-2-filtered.vcf ^
    --verbose=Y ^
    --trace=N ^
    --tvi=NONE
