...
rem This script executes a test of the program transcriptome-stats.py
...
rem Execute the program transcriptome-stats.py

python.exe %PYTHON_OPTIONS% transcriptome-stats.py ^
