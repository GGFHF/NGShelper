...
rem This script performs a test of the program transcriptome-stats.py
...
rem Run the program transcriptome-stats.py

%PYTHON% %PYTHON_OPTIONS% transcriptome-stats.py ^
