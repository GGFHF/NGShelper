...
rem This script executes a test of the program load-gene2go.py
...
rem Execute the program load-gene2go.py

python.exe %PYTHON_OPTIONS% load-gene2go.py ^
    --db=%DATA_DIR%\gymnoTOA.db ^
    --relfile=%DATA_DIR%\gene2go.gz ^
    --verbose=Y ^
    --trace=N
