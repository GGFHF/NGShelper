...
rem This script fixes sequence identifiers of a read file generated by simNGS to
rem compatible format with CASAVA.
...
rem Execute the program simNGS-read-fixing.py

python.exe %PYTHON_OPTIONS% simNGS-read-fixing.py %* %ARGV%
