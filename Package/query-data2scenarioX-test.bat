...
rem This script executes a test of the program query-data2scenarioX.py
...
rem Execute the program query-data2scenarioX.py

python.exe %PYTHON_OPTIONS% query-data2scenarioX.py ^
