...
rem This program loads annotation data from a TOA annotation file into NGShelper database.
...
rem Execute the program load-annotations.py

python.exe %PYTHON_OPTIONS% load-annotations.py %* %ARGV%
