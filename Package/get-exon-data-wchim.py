...
'''
This program parses a GMAP alignment considering chimeras (GMAP options -n 0 -m) in order to get data about
the coverage, identity and coordinates of exons.
...
def build_parser():
    ...
    description = 'Description: This program parses a GMAP alignment considering chimeras (GMAP options -n 0 -m) in order to get data about the coverage, identity and coordinates of exons.'
...
def get_exon_data(alignment_file, output_dir):
    '''
    Parse a GMAP alignment considering chimeras (GMAP options -n 0 -m) in order to get data about
    the coverage, identity and coordinates of exons.
    '''
