...
rem This script generates a Nexus file from a ypirad loci file for a determinated
rem loci set to be used by BEAST software.
...
rem Execute the program loci2nexus.py

:LOCI2NEXUS

python.exe %PYTHON_OPTIONS% loci2nexus.py %* %ARGV%
