...
rem This script executes a test of the program filter-fasta.py in a Windows
rem environment.
...
rem Execute the program filter-fasta.py

python.exe %PYTHON_OPTIONS% filter-fasta.py ^
