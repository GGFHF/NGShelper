...
rem This script executes a test of the program load-protaccession2taxid.py
...
rem Execute the program load-protaccession2taxid.py

python.exe %PYTHON_OPTIONS% load-protaccession2taxid.py ^
    --db=%DATA_DIR%\gymnoTOA.db ^
    --relfile=%DATA_DIR%\prot.accession2taxid.gz ^
    --topnode=58019 ^
    --verbose=Y ^
    --trace=N
