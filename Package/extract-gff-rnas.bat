...
rem This program extracts RNA sequences from a GFF file and its corresponding
rem genome FASTA file.
...
rem Execute the program extract-gff-rnas.py

python.exe %PYTHON_OPTIONS% extract-gff-rnas.py %* %ARGV%
