...
rem This script executes a test of the program load-taxonomy-data.py
...
rem Execute the program load-taxonomy-data.py

python.exe %PYTHON_OPTIONS% load-taxonomy-data.py ^
    --db=%DATA_DIR%\NGShelper.db ^
    --nodes=%DATA_DIR%\taxdmp\nodes.dmp ^
    --names=%DATA_DIR%\taxdmp\names.dmp ^
    --verbose=Y ^
    --trace=N
