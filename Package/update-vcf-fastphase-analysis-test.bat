...
rem This script performs a test of the program update-vcf-fastphase-analysis.py
...
rem Run the program update-vcf-fastphase-analysis.py

%PYTHON% %PYTHON_OPTIONS% update-vcf-fastphase-analysis.py ^
    --invcf=%DATA_DIR%\test-SUBERINTRO-AL-B-wmd.vcf ^
    --outvcf=%OUTPUT_DIR%\test-SUBERINTRO-AL-B-imputed-fastphase.vcf ^
    --analdir=%OUTPUT_DIR%\vcf2fastphase-AL-B ^
