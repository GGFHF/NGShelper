...
rem This program builds the allele frequency from a VCF file in the format required
rem by SimHyb application.
...
python.exe %PYTHON_OPTIONS% build-allele-frequency.py %* %ARGV%
