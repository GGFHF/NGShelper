...
rem This script executes a test of the program extract-vcf-seqs.py
...
rem Execute the program extract-vcf-seqs.py

python.exe %PYTHON_OPTIONS% extract-vcf-seqs.py ^
    ...
    --extract=%OUTPUT_DIR%\concatenated_imputed_progenies-6000DP-scenario2-extracted.vcf ^
    --verbose=Y ^
    --trace=N
