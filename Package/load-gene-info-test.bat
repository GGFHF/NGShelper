...
rem This script executes a test of the program load-gene-info.py
...
python.exe %PYTHON_OPTIONS% load-gene-info.py ^
    --db=%OUTPUT_DIR%\ngshelper-scenario2.db ^
    --gene=%DATA_DIR%\All_Plants.gene_info.gz ^
    --verbose=Y ^
    --trace=N
