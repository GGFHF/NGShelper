...
rem This script performs a test of the program filter-ssrs.py
...
rem Run the program filter-ssrs.py

%PYTHON% %PYTHON_OPTIONS% filter-ssrs.py ^
    --cos=%DATA_DIR%\nana_scb_merged.fasta ^
