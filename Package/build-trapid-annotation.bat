...
rem This script builds functional annotation data corresponding to a TRAPID run.
...
rem Execute the program build-trapid-annotation.py

python.exe %PYTHON_OPTIONS% build-trapid-annotation.py %* %ARGV%
