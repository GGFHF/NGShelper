...
'''
This program loads genomic features from a GFF file into SQLite database.
...
def build_parser():
    ...
    description = 'Description: This program loads genomic features from a GFF file into SQLite database.'
