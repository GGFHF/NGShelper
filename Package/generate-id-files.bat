...
rem This script runs the program generate-id-files.py in a Windows environment.
rem
...
rem Execute the program generate-id-files.py

:TRANSCRIPT_FILTER

%PYTHON% %PYTHON_OPTIONS% generate-id-files.py %* %ARGV%
