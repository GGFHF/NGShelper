...
rem This script converts a output SimHyb file to the input Structure format in two lines.
...
rem Execute the program simhyb2structure.py

python.exe %PYTHON_OPTIONS% simhyb2structure.py %* %ARGV%
