...
rem This script performs a test of the program load-genomic-features.py
...
rem Run the program load-genomic-features.py

%PYTHON% %PYTHON_OPTIONS% load-genomic-features.py ^
