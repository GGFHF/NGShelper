...
rem This script executes a test of the program vcf2structure.py
...
rem Execute the program vcf2structure.py

python.exe %PYTHON_OPTIONS% vcf2structure.py ^
    ...
    --trans=ADD100 ^
    --type=0 ^
    --out=%OUTPUT_DIR%\concatenated_imputed_progenies-6000DP-scenario2-2structure.txt ^
    --verbose=Y ^
    --trace=N ^
    --tvi=NONE
