...
rem This script performs a test of the program correct-imputation-info.py
...
rem Run the program correct-imputation-info.py

%PYTHON% %PYTHON_OPTIONS% correct-imputation-info.py ^
    --in=%DATA_DIR%\summary-file.csv ^
    --out=%OUTPUT_DIR%\summary-file-corrected.csv ^
    --verbose=Y ^
    --trace=N
