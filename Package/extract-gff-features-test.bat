...
rem This script executes a test of the program extract-gff-features.py
...
rem Execute the program extract-gff-features.py

python.exe %PYTHON_OPTIONS% extract-gff-features.py ^
